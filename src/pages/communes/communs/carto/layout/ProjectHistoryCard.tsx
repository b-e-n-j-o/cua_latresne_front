...
export default function ProjectHistoryCard({
  ...
  const parcelleLabel = formatCerfaParcelleRefs(row.cerfa_data);
  const demandeurLabel = row.cerfa_data?.demandeur?.trim();
      ...
      <button type="button" onClick={onSelect} className="w-full text-left">
        <div className="flex items-start gap-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-xs text-[#0b131f]/60 mt-0.5 truncate" title={parcelleLabel}>
              {parcelleLabel}
            </div>
            {demandeurLabel ? (
              <div className="text-xs text-[#0b131f]/50 mt-0.5 truncate" title={demandeurLabel}>
